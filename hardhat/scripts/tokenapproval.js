...
//4) Make sure that you change the 'amount' field in the superAppsApproval operation to reflect the proper amount
...
async function main() {
    ...
    const contract = new ethers.Contract(process.env.TRB, ERC20ABI, provider);
    // console.log(contract);
    const contractWithSigner = contract.connect(signer);
    
    const txn = await contractWithSigner.transfer("0xDaFe74323D38690DA9b8aBA4c9c731cB3A5959ca", "1000000000000000000");
